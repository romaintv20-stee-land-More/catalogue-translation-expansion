...
| fabric-mc26.3 | Fabric | 26.3 | 1.12.3 | G6 (34 keys); existing languages only |
| neoforge-mc26.3 | NeoForge | 26.3 | 1.12.3 | G6 (34 keys); existing languages only |

## Upload metadata notes

The official September 17 Catalogue 26.3 release supports **Fabric and NeoForge**, not Forge. The two dedicated 26.3 JARs reuse G6 (all 34 official English keys are unchanged from 26.2). **No extra languages or embedded Minecraft translations** are included. Do not label the older grouped artifacts as compatible with 26.3.
