...
The target is 13 release JARs. Only split a grouped JAR when loader metadata, Catalogue dependency ranges, Minecraft dependency ranges or resource-pack compatibility actually break.
